...
namespace CAI_2_3_2023_POO_Agenda_Intento2
{
    public class Contacto
    {
        ...
        public Contacto(int codigoContacto, string nombreContacto, string apelidoContacto, string telefonoContacto, string direccionContacto, DateTime fechaNacimiento, int llamadas)
        {
